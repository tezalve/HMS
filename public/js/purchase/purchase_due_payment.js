...
// **************************Start customer wise list**********************************
              ...
              var dataSet = data.data;
                ...
                "data":     dataSet,
                  "footerCallback": function ( row, data, start, end, display ) {
                      ...
                      $( md_table.column(1).footer()).html("Total Purchase Amount");
 ...
 $('#frm_purchase_due').on('submit',(function(e) {
           e.preventDefault();
          ...
          $("#btnSubmit").val('Please wait..');
                 ...
                 $.ajax({
                  ...
                  if(data.success == true) {
                        ...
                        window.location.replace('/purchase_due_payment');
