@csrf
    <div class="col-lg-6 col-md-6 col-xs-12">
        <div class="col-lg-12 entry_panel_body ">
            <label for="Medicine Name" class="col-lg-5 col-md-5 col-xs-5 entry_panel_label">permission</label>
            <input name="name" type="text" id="name" value="{{ old('name',$permission->name??null) }}" placeholder="permission" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
        </div>
    </div>
