    ...
    <form action="{{ route('doctors.update',$doctor->id) }}" method="POST">
        ...
        <div class="col-lg-6 col-md-6 col-xs-12">
			<div class="col-lg-12 entry_panel_body ">
				...
				<input name="name" value="{{$doctor->name}}" type="text" id="name" placeholder="Doctor Name" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
			</div>
		</div>
		...
		<div class="col-lg-6 col-md-6 col-xs-12">
			<div class="col-lg-12 entry_panel_body ">
				...
				<input name="doctor_degree" value="{{$doctor->doctor_degree}}" type="text" id="doctordegree" placeholder="Doctor Degree.." class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
			</div>
		</div>	
		...
		<div class="col-lg-6 col-md-6 col-xs-12">
			<div class="col-lg-12 entry_panel_body ">
				...
				<input name="address" value="{{$doctor->address}}" type="text" id="address" placeholder="Address" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
			</div>
		</div>	
		...
		<div class="col-lg-6 col-md-6 col-xs-12">
			<div class="col-lg-12 entry_panel_body ">
				...
				<input name="phone" value="{{$doctor->phone}}" type="text" id="phone" placeholder="Phone No" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
			</div>
		</div>			
		...
		<div class="col-lg-6 col-md-6 col-xs-12">
			<div class="col-lg-12 entry_panel_body ">
				...
				<input name="consultation_fee" value="{{$doctor->consultation_fee}}" type="text" id="consultation_fee" placeholder="1000" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
			</div>
		</div>	
