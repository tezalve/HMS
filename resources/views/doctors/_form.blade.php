@csrf
    <div class="col-lg-6 col-md-6 col-xs-12">
        <div class="col-lg-12 entry_panel_body ">
            ...
            <input name="name" value="{{ old('name',$doctor->name??null) }}" type="text" id="name" placeholder="Doctor Name" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-xs-12">
        <div class="col-lg-12 entry_panel_body ">
            ...
            <input name="doctor_degree" value="{{old('doctor_degree', $doctor->doctor_degree??null)}}" type="text" id="doctordegree" placeholder="Doctor Degree.." class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
        </div>
    </div>	
    ...
    <div class="col-lg-6 col-md-6 col-xs-12">
        <div class="col-lg-12 entry_panel_body ">
            ...
            <input name="address" value="{{old('address', $doctor->address??null)}}" type="text" id="address" placeholder="Address" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
        </div>
    </div>	
    ...
    <div class="col-lg-6 col-md-6 col-xs-12">
        <div class="col-lg-12 entry_panel_body ">
            ...
            <input name="phone" value="{{old('phone', $doctor->phone??null)}}" type="text" id="phone" placeholder="Phone No" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
        </div>
    </div>			
    ...
    <div class="col-lg-6 col-md-6 col-xs-12">
        <div class="col-lg-12 entry_panel_body ">
            ...
            <input name="email" value="{{old('email', $doctor->email??null)}}" type="text" id="email" placeholder="email@domain.com" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
        </div>
    </div>		
    ...
    <div class="col-lg-6 col-md-6 col-xs-12">
        <div class="col-lg-12 entry_panel_body ">
            ...
            <input name="dob" value="{{old('dob', $doctor->dob??null)}}" type="text" id="dob" placeholder="dd-mm-yyyy" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
        </div>
    </div>	
    ...
    <div class="col-lg-6 col-md-6 col-xs-12">
        <div class="col-lg-12 entry_panel_body ">
            ...
            <input name="consultation_fee" value="{{old('consultation_fee', $doctor->consultation_fee??null)}}" type="text" id="consultation_fee" placeholder="1000" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
        </div>
    </div>	
