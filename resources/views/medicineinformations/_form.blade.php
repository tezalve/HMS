    @csrf
        ...
        <div class="col-lg-6 col-md-6 col-xs-12 hidden">
            <div class="col-lg-12 entry_panel_body ">
                ...
                <input name="users_id" type="number" id="users_id" value="{{ old('users_id',$medicineinformation->users_id??null) }}" placeholder="Default Vat" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">
            </div>
        </div>
