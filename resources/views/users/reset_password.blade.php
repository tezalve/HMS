...
<div class="box box-primary">
	...
	<form class="form-horizontal" method="POST" action="{{url('password_reset')}}" onkeypress = "return event.keyCode != 13;" id="reset_password_form">
		{{ csrf_field() }}
		<div class="box-body">
			<div class="row">
				<div class="col-md-12">
...
<script src="{{asset('js/users/reset_password.js')}}"></script>
        ...
        fields: {
            password: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^(?=.*?[A-Z])(?=.*?[0-9]).{6,12}$/,
                        message: 'Password should be with at least one Capital Letter and 1 number'
                    }
