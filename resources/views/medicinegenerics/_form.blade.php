@csrf
    <div class="col-lg-6 col-md-6 col-xs-12">
        <div class="col-lg-12 entry_panel_body ">
            ...
            <input name="generic_name" type="text" id="generic_name" value="{{ old('generic_name',$medicinegeneric->generic_name??null) }}" placeholder="Generic Name" class="col-lg-7 col-md-7 col-xs-7 entry_panel_input">				
        </div>
    </div>
